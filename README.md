...
где пользователь заходит на сайт, регистрируется и
авторизируется.
На главной странице посетитель, после успешного входа,
...
используются для проверки Логина и Email на уникальность.  
